        ...
        <ul>
         <li><a class="nav-link scrollto " href="OwnerHome.jsp">Home</a></li>
          ...
          <li><a class="nav-link scrollto" href="ViewEVStationdetails.jsp">ManageStationDetails</a></li>
           ...
           <li><a class="nav-link scrollto active" href="ViewBookingStationdetails.jsp">ManageEVBookingDetails</a></li>
         ...
         <div class="row">
          ...
          <div class="col-md-12">
                   ...
                   /*   String mobileno=(String)session.getAttribute("mobileno");  */
                     ...
                     ResultSet rs=st.executeQuery("select * from bookevstation where mobileno='"+mobileno+"'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No booking Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
                    	...
                    	<td style="color:black"><%=rs.getString(6) %></a></td>
                    	...
                    	<td style="color:black"><%=rs.getString(14) %></td>
                    	 <td><a style="color:red;" href="DeleteBookingCon?id=<%=rs.getInt(1)%>"><b>Cancel</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
