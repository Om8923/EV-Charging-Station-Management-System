    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="ViewFeedback.jsp">View Feedback</a></li>
           <li class="dropdown">
          ...
          <a style="color:black;">Welcome Admin<i class="bi bi-chevron-down"></i></a>
	                <ul>
	                <li class="dropdown"><a class="nav-link scrollto" href="Home.html" style="color:black;">Logout</a></li>
	                </ul>
         </li> 
          <!-- <li class="dropdown">
    ...
    <div class="portfolio" style="background-image: url(assets/img/view1.jpg)">
      <div class="container" data-aos="fade-up" >
        ...
        <div class="section-title">
          <h2 style="color:white;">View Feedback</h2>
         ...
         <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No Feedback Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
