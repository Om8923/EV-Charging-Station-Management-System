        ...
        <div class="row no-gutters">
          <div class="content col-xl-6 d-flex align-items-stretch">
           ...
           <center> <h2 class="bx bx-user">UserLogin</h2></center><br><br>
            ...
            <input type="email" name="email" class="text1" id="email"   placeholder="Enter email address" required>
            <br><br>
           ...
           <img src="assets/img/pass-hide.png" onclick="pass()" class="pass-icon" id="pass-icon"><br>
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-12 icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <img src="assets/img/usserreg1.png" class="img-fluid" alt="" style="width:600px; height:350px;"><br><br>
