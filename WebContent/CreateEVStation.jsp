      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
         ...
         <li><a class="nav-link scrollto " href="OwnerHome.jsp">Home</a></li>
          <li><a class="nav-link scrollto active" href="CreateEVStation.jsp">Create EV Station</a></li>
...
<div class="row justify-content-center">
          ...
          <div class="col-xl-6 col-lg-6 pt-5 pt-lg-0" >
            ...
            <h2>Create EV Station</h2><br>
            <br>
             <form action="EVCreateStationServlet" method="post" >
             <div class="form-group mt-1">
            <input type="text" name="ownername" class="form-control" id="ownername" placeholder="Enter Your Name" required>
          </div>
          <div class="form-group mt-1">
         ...
         <div class="form-group mt-1">
          <input type="text" name="path" class="form-control" id="path"   placeholder="Enter Location path" required>
           ...
           <div class="form-group mt-1">
          <input type="text" name="mobileno" class="form-control" id="mobileno" value="${mobileno}" placeholder="Enter Mobile Number" required>
         </div>
         <div class="form-group mt-1">
