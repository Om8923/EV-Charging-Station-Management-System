         ...
         <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from bookevstation where name='"+name+"'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No Bookings Present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
                    	...
                    	<td><a style="color:red;" href="DeleteBookingCon1?id=<%=rs.getInt(1)%>"><b>Cancel</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
